...
class _SQLAlchemyState(object):
    """Remembers configuration for the (migrations, app) tuple."""
...
class SQLAlchemy(object):
    ...
    declare models like this::
        ...
        class User(migrations.Model):
            username = migrations.Column(migrations.String(80), unique=True)
            pw_hash = migrations.Column(migrations.String(80))
    ...
    :class:`BaseQuery` for `migrations.Query`, `migrations.Model.query_class`, and the default
    query_class for `migrations.relationship` and `migrations.backref`.  If you use these
    ...
    .. admonition:: Check types carefully
       ...
       Don't perform type or `isinstance` checks against `migrations.Table`, which
       emulates `Table` behavior but is not a class. `migrations.Table` exposes the
    ...
    @property
    def metadata(self):
        """The metadata associated with ``migrations.Model``."""
    ...
    def get_binds(self, app=None):
        ...
        This is suitable for use of sessionmaker(binds=migrations.get_binds(app)).
        """
        app = self.get_app(app)
