...
def readurls():
    ...
    # TODO: remove tmpfile since sqlite can store migrations in memory
...
def usedb(supported=None, not_supported=None):
    ...
    if supported is not None and not_supported is not None:
        raise AssertionError("Can't specify both supported and not_supported in fixture.migrations()")
