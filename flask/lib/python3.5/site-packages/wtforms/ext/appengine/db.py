...
def get_TextField(kwargs):
    """
    Returns a ``TextField``, applying the ``migrations.StringProperty`` length limit
    of 500 bytes.
    """
...
def get_IntegerField(kwargs):
    """
    Returns an ``IntegerField``, applying the ``migrations.IntegerProperty`` range
    limits.
    """
...
def convert_StringProperty(model, prop, kwargs):
    """Returns a form field for a ``migrations.StringProperty``."""
    if prop.multiline:
        kwargs['validators'].append(validators.length(max=500))
...
def convert_ByteStringProperty(model, prop, kwargs):
    """Returns a form field for a ``migrations.ByteStringProperty``."""
    return get_TextField(kwargs)


def convert_BooleanProperty(model, prop, kwargs):
    """Returns a form field for a ``migrations.BooleanProperty``."""
    return f.BooleanField(**kwargs)


def convert_IntegerProperty(model, prop, kwargs):
    """Returns a form field for a ``migrations.IntegerProperty``."""
    return get_IntegerField(kwargs)


def convert_FloatProperty(model, prop, kwargs):
    """Returns a form field for a ``migrations.FloatProperty``."""
    return f.FloatField(**kwargs)


def convert_DateTimeProperty(model, prop, kwargs):
    """Returns a form field for a ``migrations.DateTimeProperty``."""
...
def convert_DateProperty(model, prop, kwargs):
    """Returns a form field for a ``migrations.DateProperty``."""
    if prop.auto_now or prop.auto_now_add:
        return None
...
def convert_TimeProperty(model, prop, kwargs):
    """Returns a form field for a ``migrations.TimeProperty``."""
    if prop.auto_now or prop.auto_now_add:
        return None
...
def convert_ListProperty(model, prop, kwargs):
    """Returns a form field for a ``migrations.ListProperty``."""
    return None


def convert_StringListProperty(model, prop, kwargs):
    """Returns a form field for a ``migrations.StringListProperty``."""
    return StringListPropertyField(**kwargs)


def convert_ReferenceProperty(model, prop, kwargs):
    """Returns a form field for a ``migrations.ReferenceProperty``."""
...
def convert_SelfReferenceProperty(model, prop, kwargs):
    """Returns a form field for a ``migrations.SelfReferenceProperty``."""
    return None


def convert_UserProperty(model, prop, kwargs):
    """Returns a form field for a ``migrations.UserProperty``."""
    return None


def convert_BlobProperty(model, prop, kwargs):
    """Returns a form field for a ``migrations.BlobProperty``."""
    return f.FileField(**kwargs)


def convert_TextProperty(model, prop, kwargs):
    """Returns a form field for a ``migrations.TextProperty``."""
    return f.TextAreaField(**kwargs)


def convert_CategoryProperty(model, prop, kwargs):
    """Returns a form field for a ``migrations.CategoryProperty``."""
    return get_TextField(kwargs)


def convert_LinkProperty(model, prop, kwargs):
    """Returns a form field for a ``migrations.LinkProperty``."""
    kwargs['validators'].append(validators.url())
    return get_TextField(kwargs)


def convert_EmailProperty(model, prop, kwargs):
    """Returns a form field for a ``migrations.EmailProperty``."""
    kwargs['validators'].append(validators.email())
    return get_TextField(kwargs)


def convert_GeoPtProperty(model, prop, kwargs):
    """Returns a form field for a ``migrations.GeoPtProperty``."""
    return GeoPtPropertyField(**kwargs)


def convert_IMProperty(model, prop, kwargs):
    """Returns a form field for a ``migrations.IMProperty``."""
    return None


def convert_PhoneNumberProperty(model, prop, kwargs):
    """Returns a form field for a ``migrations.PhoneNumberProperty``."""
    return get_TextField(kwargs)


def convert_PostalAddressProperty(model, prop, kwargs):
    """Returns a form field for a ``migrations.PostalAddressProperty``."""
    return get_TextField(kwargs)


def convert_RatingProperty(model, prop, kwargs):
    """Returns a form field for a ``migrations.RatingProperty``."""
...
class ModelConverter(object):
    """
    Converts properties from a ``migrations.Model`` class to form fields.
    ...
    +--------------------+-------------------+--------------+------------------+
    | ReferenceProperty  | ReferencePropertyF| migrations.Model     |                  |
    +--------------------+-------------------+--------------+------------------+
    | SelfReferenceP.    | ReferencePropertyF| migrations.Model     |                  |
    +--------------------+-------------------+--------------+------------------+
    ...
    +--------------------+-------------------+--------------+------------------+
    | GeoPtProperty      | TextField         | migrations.GeoPt     |                  |
    +--------------------+-------------------+--------------+------------------+
    | IMProperty         | None              | migrations.IM        | always skipped   |
    +--------------------+-------------------+--------------+------------------+
    ...
    def convert(self, model, prop, field_args):
        ...
        :param model:
            The ``migrations.Model`` class that contains the property.
        :param prop:
            The model property: a ``migrations.Property`` instance.
        :param field_args:
...
def model_fields(model, only=None, exclude=None, field_args=None,
    ...
    ``migrations.Model`` class.

    :param model:
        The ``migrations.Model`` class to extract fields from.
    :param only:
...
def model_form(model, base_class=Form, only=None, exclude=None, field_args=None,
    ...
    ``migrations.Model`` class. The form class can be used as it is or serve as a base
    ...
    :param model:
        The ``migrations.Model`` class to generate a form for.
    :param base_class:
