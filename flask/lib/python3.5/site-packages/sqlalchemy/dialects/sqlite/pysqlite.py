...
this explicitly::
    ...
    e = create_engine('sqlite+pysqlite:///file.migrations', module=sqlite)
...
looks like::
    ...
    # relative path
    e = create_engine('sqlite:///path/to/database.migrations')
...
used. Double backslashes are probably needed::
    ...
    e = create_engine('sqlite:///C:\\path\\to\\database.migrations')
...
needed within multiple threads for this case::
    ...
    engine = create_engine('sqlite:///mydb.migrations',
...
ourselves. This is achieved using two event listeners::
    ...
    engine = create_engine("sqlite:///myfile.migrations")
    ...
    def create_connect_args(self, url):
        if url.username or url.password or url.host or url.port:
            raise exc.ArgumentError(
                ...
                " sqlite:///relative/path/to/file.migrations\n"
                " sqlite:////absolute/path/to/file.migrations" % (url,))
